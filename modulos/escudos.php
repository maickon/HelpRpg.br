...
$selectLabels1 = array('Esta escudo é público ou privado?');
$selectNames1 = array('dominio');
$selectOptions1 = array('Publico','Privado');

$selectLabels2 = array('Categoria');
$selectNames2 = array('categoria');
$selectOptions2 = array('Escudos Leves','Escudos Médio','Escudos Pesados');

$selectLabels3 = array('Tipo');
$selectNames3 = array('tipo');
$selectOptions3 = array('Escudo');

$selectLabels4 = array('Nivel do escudo');
...
$pagina_nome = 'Cadastrando escudos no sistema.';
$descriacao= array('create'=>'Cadastrando um escudo no sistema do Help Rpg.',
				   'edit'=>'Editando um escudo no sistema do Help Rpg',
				   'destroy'=>'Apagando um escudo no sistema do Help Rpg');
