...
$tag->open('html','lang=""');
	$tag->open('head');
		$tag->open('meta','http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"');
		...
		$tag->open('link','rel="stylesheet" href="css/jquery-ui-1.10.4.custom.css"');
	...
	$tag->open('body');
		...
		$tag->open('div','class="row top '.rand_logo_bar().'"');
